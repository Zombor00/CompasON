...
public class FormularioAlbum extends JPanel {
	...
	public FormularioAlbum(ArrayList<String> nombreCanciones) {
		...
		layout.putConstraint(SpringLayout.VERTICAL_CENTER, anioLabel,0,SpringLayout.VERTICAL_CENTER, comboAnios);
		layout.putConstraint(SpringLayout.WEST, anioLabel,0,SpringLayout.WEST, nombreLabel);
